...
# add PayPal to the INSTALLED_APPS list
INSTALLED_APPS = [
    'PayPal',
...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware', # enable whitenoise to serve static files in production
]
...
# configure local database for development
DATABASES = {
    'default': {
